...
const Work = () => (
  ...
  >
    <div className="flex items-center justify-between">
      <h2 className="text-4xl text-green sm:text-5xl font-bold">03. Some Things I've Built</h2>
    </div>
    ...
    <h3 className="mt-12 text-4xl sm:text-5xl font-bold">Other Projects</h3>
